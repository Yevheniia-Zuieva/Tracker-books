 ...
 */
  ...
  const faqs = [
    ...
    {
      question: "Що таке 'рівень читацької активності'?",
      answer:
        "Це кількісний показник вашої ефективності. Він враховує обсяг прочитаного (кількість прочитаних сторінок), регулярність читання (днів на тиждень) та жанрову різноманітність.",
    },
    {
      question: "Як працює історія перечитувань?",
      answer:
        "Якщо ви вже прочитали книгу, ви можете натиснути на кнопку 'Читати знову' на сторінці книги. Система збереже дати попереднього прочитання в архіві та запустить новий цикл відстеження.",
    },
    {
      question: "Чи можу я редагувати нотатки чи цитати?",
      answer:
        "Так, на сторінці кожної книги у блоці 'Мій архів думок' або 'Колекція висловів' при наведенні на картку з’являються іконки редагування та видалення. Також на сторінках 'Усі нотатки' та 'Усі цитати' є також можливість редагування та видалення. Всі зміни синхронізуються миттєво.",
    },
    {
      question: "Навіщо потрібен таймер сесій?",
      answer:
        "Таймер допомагає точно фіксувати чистий час, витрачений на читання. Ці дані використовуються для побудови детальної статистики у вашому профілі.",
    },
    {
      question: "Чи можна видалити книгу з бібліотеки?",
      answer:
        "Так, на сторінці кожної книги або безпосередньо на картці (для книг, доданих вручну) є можливість видалення запису.",
    },
    {
      question: "Як видалити свій профіль?",
      answer:
        "Ви можете зробити на сторінці  профілю 'Мій акаунт' у розділі 'Небезпечна зона'. Будьте уважні: всі ваші дані, книги та статистика будуть видалені назавжди.",
    },
  ];
