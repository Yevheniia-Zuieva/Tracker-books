...
export function Header({ user, onLogout }) {
  ...
  const location = useLocation(); // Дозволяє дізнатися, на якій ми сторінці за адресою
  ...
  // Функція для кліку по пунктах меню
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-xl border bg-popover p-2 text-popover-foreground shadow-xl animate-in fade-in zoom-in-95 duration-200">
                <div className="px-3 py-2 border-b mb-1 text-left">
                  <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Мій кабінет</p>
